...
<main class="flex-grow flex items-center justify-center pt-32 pb-16">		<div class="container mx-auto p-4 lg:p-8">
			<div class="flex flex-col lg:flex-row w-full max-w-4xl mx-auto overflow-hidden rounded-2xl shadow-2xl bg-white animate-fade-in">
				...
				<div class="w-full lg:w-1/2 p-8 md:p-12">
					<div class="text-center">
						<LogIn class="mx-auto text-orange-500 mb-4" size={48} />
						<h1 class="text-3xl font-bold text-gray-800 mb-2">Bon retour !</h1>
						<p class="text-gray-600 mb-8">Connectez-vous pour continuer.</p>
					</div>
					...
					<div class="mt-8 text-center">
						<p class="text-sm text-gray-600">
							...
							<a href="/register" class="font-medium text-orange-600 hover:underline">Inscrivez-vous</a>
						</p>
					</div>
				</div>
			</div>
